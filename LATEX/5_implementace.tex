...
Z toho dùvodu jsem musel provést nìkolik zmìn v programu \texttt{JHOVE2} i nástroji \texttt{WARC-TOOLS}, respektive jsem zmìnu provedl jen v nástroji \texttt{WARC-TOOLS / hanzo}. Zmìna v ostatních nástrojích \texttt{WARCTOOLS} by znamenala obdobné zásahy do zdrojového kódu a pravdìpodobnì by vedla ke stejným výsledkùm, jak vyplývá z mého porovnání nástrojù.
