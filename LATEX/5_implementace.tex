...
Dal¹ím dùle¾itým nástrojem je nástroj \texttt{warcvalid.py}. Tento nástroj slou¾í k validaci \texttt{warc} archivù jeví jako vhodný pro kontrolu validity nových \texttt{warc} archivù vzniklých pøi migraci.

Díky nástroji jsem odhalil problémy s migraèním nástrojem, který popisuju v kapitole vìnované haváriím nástroje.
