...
\subsection{Úvod}
Bìhem analýzy pøevádìných souborù jsem narazil na nìkolik problémù. Zároveò jsem byl nucen pou¾ívat i ostatní nástroje ze sady \texttt{WARCTOOLS / hanzo}. V následujících kapitlách se budu vìnovat obìma øeèeným tématùm.

\subsection{Analýza havárií pøi migraci archivu}
Jak jsem zjistil, nástroje \texttt{WARCTOOLS / hanzo} i \texttt{WARCTOOLS / kpk09} havarují pøi pøevodu nìkterých archivù. Mým cílem bylo zjistit, co pøesnì pùsobí havárii. 

Pøi migraci nìkterých archivù z repozitáøe Webarchiv
...
\begin{table}[htbp!]
\caption{Doby migrace souborù}
\label{tabulka_obsahu_webarchivu}
\begin{center}
\begin{tabular}{|l||c|c|c|c|c|c|}
\hline
\textbf{Pokus}&\textbf{MB}&\textbf{Souborù}&\textbf{\texttt{WARCTOOLS}}&\textbf{\texttt{JHOVE2}}&\textbf{Èas validace}\\
\hline
1	&	100	&	3 682&	31 s&	2 m 50 s&	10 s\\
1	&	100	&	3 682&	32 s&	46.35: 2 m 50 s&	10 s\\
\hline
Prùmìr	&	3 017 05	&	106 520	&	&	&	\\
\hline
\end{tabular}
\end{center}
\end{table}
