...
\begin{description}
\item[Warcinfo] popisuje ostatní \texttt{warc} záznamy, které ho následují. Typicky je na zaèátku \texttt{WARC} souboru. Má tedy èistì informativní charakte. Lze v nìm najít informace o tom, jaký software daný soubor vytvoøil, \texttt{IP adresa} stroje na kterém byl vytvoøen atd.  Pøíklad záznamu v \texttt{pøíloze K na s. \pageref{pr:s}}.
...
Dùle¾itým aspektem standardu \texttt{warc} je mo¾nost \texttt{deduplikace} souborù. Jedná se o mo¾nost odstranìní tìch souborù, které se v repozitáøi objevují vícekrát.
