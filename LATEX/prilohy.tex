...
\label{pr:w}
\section*{W. \texttt{WARC-TOOLS / hanzo} -- \texttt{README} soubor}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{warctools\_hanzo\_README}.
\label{pr:x}
\section*{X. \texttt{WARC-TOOLS / hanzo} -- výstup z nástroje \texttt{warcdump} pro \texttt{warc} soubor}
...
\label{pr:y}
\section*{Y. \texttt{WARC-TOOLS / hanzo} -- výstup z programu \texttt{JHOVE2} pro pøilo¾ený \texttt{warc} soubor}
...
\label{pr:z}
\section*{Z. \texttt{WARC-TOOLS / kpk09} -- \texttt{README} soubor}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{warctools\_kpk09\_README}.
\label{pr:aa}
\section*{AA. \texttt{WARC-TOOLS / kpk09} -- výstup z nástroje \texttt{warcdump} pro \texttt{warc} soubor}
...
\label{pr:ab}
\section*{AB. \texttt{WARC-TOOLS / kpk09} -- výstup z programu \texttt{JHOVE2} pro pøilo¾ený \texttt{warc} soubor}
...
\label{pr:ak}
\section*{AK.  \texttt{JHOVE2} -- vlastní implementace nástroje}
...
\label{pr:al}
\section*{AL. \texttt{WARC-TOOLS / hanzo} -- vlastní implementace nástroje}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{arc2warc\_jhove.py}. Aby správnì fungoval, je potøeba mít nainstalován nástroj Jpype (\texttt{pøíloha AI na s. \pageref{pr:ai}}) a umístit soubor do koøenové slo¾ky \texttt{WARC-TOOLS / hanzo} (\texttt{pøíloha AD na s. \pageref{pr:ad}}).
\label{pr:am}
...
\label{pr:aq}
\section*{AQ. \texttt{JHOVE2} -- vlastní implementace nástroje}
...
\label{pr:ar}
\section*{AR. Nahlá¹ení chyby v nástroji \texttt{WARC-TOOLS / hanzo} vývojáøùm}
Soubory je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{hanzo\_mail}.
\label{pr:as}
\section*{AS. Migrace vzorku souborù}
Ve slo¾ce \texttt{MIGRACE} jsou obsa¾eny testované \texttt{arc} soubory a i výsledné \texttt{warc} soubory. Slo¾ka obsahuje obì varianty vzniklých \texttt{warc} souborù podle pou¾ití nástroje. Rozdílnost souborù popisuju v kapitole kde se vìnuji havárii nástroje \texttt{WARC-TOOLS / hanzo}. 
