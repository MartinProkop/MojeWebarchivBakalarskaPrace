...
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{IAH-20110905093545-00000-kovar-laptop-8090.arc.gz\_jhove2\-output.xml}.
\label{pr:h}
...
\label{pr:ak}
\section*{AK. \texttt{JHOVE2} -- vlastní implementace nástroje -- varianta pro testování celého archivu}
Celý soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{RunFromARC2WARC.java}. V rámci projektu nástroje \texttt{JHOVE2} musí být souèásti \texttt{package org.jhove2.app}. Zde ukazuji pouze metodu tøídy (\texttt{runJHOVE2}), která obstarává spu¹tìní \texttt{JHOVE2}. \\
\texttt{/**\\
...
\} }
\label{pr:al}
\section*{AL. \texttt{WARCTOOLS / hanzo} -- vlastní implementace nástroje -- varianta pro testování celého archivu}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{arc2warc\_jhove2.py}. Aby správnì fungoval, je potøeba mít nainstalován nástroj Jpype (\texttt{pøíloha AI na s. \pageref{pr:ai}}) a umístit soubor do koøenové slo¾ky WARCTOOLS / hanzo (\texttt{pøíloha AD na s. \pageref{pr:ad}}).
\label{pr:am}
...
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{HANZO\_IAH-20110905093545-00000-kovar-laptop-8090\_sjhove\-.warc.gz}.
\label{pr:aq}
\section*{AQ. Soubor obsahujcí analýzu obsahu migrovaného archivu. Pro vytvoøení jsem pou¾il mnou upranený nástroj \texttt{WARC-TOOLS / HANZO}.}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{HANZO\_IAH-20110905093545-00000-kovar-laptop-8090\_sjhove\-.warc.gz\_jhove2output.xml}.
\label{pr:ar}
\section*{AR. \texttt{WARCTOOLS / HANZO} -- úprava \texttt{arc2warc.py} pro testování havárií pøi migraci archivu}
Soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{arc2warc\_debug.py}.
\label{pr:as}
\section*{AS. Testování havárií pøi migraci archivu -- øádek z \texttt{CDX indexu} pro soubor na kterém migrace havarovala}
\texttt{polednik.cz/2012/04/program-letosniho-poledniku/effect.appear\\('slideshow 20120415010101 http://polednik.cz/2012/04/program\\-letosniho-poledniku/Effect.Appear('slideshow text/html 404 CV66JQAPDHM7FAJAG5JTEJ3XLEJV6EQ7 - - 605148\\ IAH-20120415005926-00000-kovar-laptop.arc.gz}
\label{pr:at}
\section*{AT. Testování havárií pøi migraci archivu -- øádek z \texttt{CDX indexu} pro soubor na kterém migrace havarovala}

\texttt{zvelebil.cz/logo/kont02.jpg 20060826121815 http://www.zvelebil\\.cz/logo/kont02.jpg image/jpeg 200 UU4T6EI35P2XRJZET4WWWGCZWRC\\NPDXA - - 14273602 IAH-20060826121552-00002-har.arc.gz}
\section*{AU. \texttt{JHOVE2} -- vlastní implementace nástroje -- varianta pro krokové testování ka¾dého souboru v archivu}
Celý soubor je dostupný jako elektronická pøíloha bakaláøské práce pod názvem \texttt{RunFromARC2WARCLoop.java}. V rámci projektu nástroje \texttt{JHOVE2} musí být souèásti \texttt{package org.jhove2.app}. Zde ukazuji pouze metodu tøídy (runJHOVE2Loop), která obstarává pøedávání jednotlivých souborù k testování. \\
\label{pr:au}
\texttt{/** \\
