...
\texttt{filedesc://IA-001102.arc 0.0.0.0 19960923142103 text/plain 200 - - 0 \\
IA-001102.arc 122 \\
2 0 Alexa Internet \\
...
RepresentationInformation: \\./IAH-20110905093545-00000-kovar-laptop-8090.arc.gz \\
\indent ReportingModule: BYTESTREAM, Rel. 1.3 (2007-04-10) \\
\indent LastModified: 2011-09-05 12:40:13 CEST \\
\indent Size: 74389018 \\
\indent Format: bytestream \\
\indent Status: Well-Formed and valid \\
\indent MIMEtype: application/octet-stream}
...
Cookie: \\
\indent PHPSESSID=009d7bb11022f80605aa87e18224d824 }
...
\texttt{/**\\
** Metoda dostane na vstup seznam souborù, které pøedá ke zpracování\\
** aplikaci JHOVE2 a nakonec na vypí¹e do zadaného souboru výstup z JHOVE2.\\
...
\subsection*{Záznam, který na nìj navazuje}
\texttt{WARC/0.18 \\
